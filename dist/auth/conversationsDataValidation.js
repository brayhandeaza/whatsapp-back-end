...
exports.UserConversationLastSeenValidation = exports.UserConversationValidationQueryParams = exports.ArchivedConversationValidationQueryParams = exports.ConversationValidationQueryParams = exports.ConversationValidationUpdateSchema = exports.ConversationValidationSchema = void 0;
...
exports.ConversationValidationUpdateSchema = joi_1.default.object({
    archivedBy: joi_1.default.number().integer().required()
});
...
exports.ArchivedConversationValidationQueryParams = joi_1.default.object({
    userId: joi_1.default.number().integer().required()
});
